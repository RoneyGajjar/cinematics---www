...
const testimonials = [
  {
    quote:
      "We tested the EGC-40 on a 45-day feature in Film City. The extension speed matched what I've seen from imported Technocranes — but when something needed adjusting mid-shoot, the engineer was there in an hour. That doesn't happen with foreign equipment.",
    name: "Rajeev Menon",
  ...
  {
    quote:
      "I spec'd the EGC-60 for an aerial stunt sequence in Rajasthan. 60 feet, full extension, 55 kg payload including the remote head. Zero whip on fast pans. The truss geometry they've built into the boom sections is genuinely better engineering than what I've rented from Europe.",
    name: "Vikram Balaji",
